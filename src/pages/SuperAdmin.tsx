...
import {
  ...
  Search, Plus, MoreHorizontal, TrendingUp, ArrowUpRight, Eye, Trash2, Edit3,
  Mail, Phone, MapPin, Calendar, ChevronLeft, ChevronRight, Lock, EyeOff,
...
type Section = "uebersicht" | "kunden" | "unternehmen" | "buchungen" | "bewertungen" | "blog" | "einstellungen";
...
// Mock data
const mockKunden = [
  { id: 1, name: "Tharindu Chanaka", registrierung: "17 Feb 2026", stadt: "Fulda", geburtsdatum: "26 Feb 1993", telefon: "1742059280", plz: "36037", status: "Active" },
  { id: 2, name: "Max Mustermann", registrierung: "13 Jan 2026", stadt: "Fulda", geburtsdatum: "16 Feb 2000", telefon: "1742059280", plz: "36037", status: "Active" },
  { id: 3, name: "Karin Reinert", registrierung: "20 Oct 2025", stadt: "Frankfurt", geburtsdatum: "11 Dec 1967", telefon: "699133190", plz: "65936", status: "Active" },
  { id: 4, name: "Mirko Hoerning", registrierung: "03 Oct 2025", stadt: "Marburg", geburtsdatum: "03 Mar 1951", telefon: "1706331225", plz: "35037", status: "Active" },
  { id: 5, name: "Dino Lalic", registrierung: "01 Sep 2025", stadt: "Frankfurt", geburtsdatum: "29 Jun 1992", telefon: "6915391405", plz: "60311", status: "Active" },
];

const mockUnternehmen = [
  { id: 1, name: "Main RT Krankentransport", registrierung: "14 Jan 2026", stadt: "Eschborn", telefax: "–", telefon: "1778389366", plz: "65760", status: "Active" },
  { id: 2, name: "Taxiunternehmen Florian Schaupp e.K.", registrierung: "17 Dec 2025", stadt: "Pfungstadt", telefax: "61578018013", telefon: "61578018282", plz: "64319", status: "Active" },
  { id: 3, name: "Chanu Kranktransportz", registrierung: "15 Dec 2025", stadt: "Fulda", telefax: "–", telefon: "66123456", plz: "36037", status: "Active" },
  { id: 4, name: "Taxi Stern", registrierung: "12 Dec 2025", stadt: "Neu-Anspach", telefax: "–", telefon: "49608194660", plz: "61267", status: "Active" },
];
        ...
        <Card className="relative w-full max-w-md border-0 shadow-2xl bg-card/80 backdrop-blur-xl overflow-hidden">
          ...
          <CardContent className="relative p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="••••••••••"
                    className="h-12 rounded-xl border-border/50 bg-muted/30 focus:bg-background transition-colors pr-12"
                  />
                  <button
            ...
            <Button
              ...
              className="w-full h-12 rounded-xl bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-base font-semibold shadow-lg shadow-primary/25 transition-all duration-300"
            >
              Anmelden
            </Button>
          </CardContent>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                { label: "Buchungen", value: "77", icon: CalendarCheck, trend: "+12%", color: "primary" },
                { label: "Unternehmen", value: "34", icon: Building2, trend: "+5%", color: "secondary" },
                { label: "Kunden", value: "8", icon: Users, trend: "+3%", color: "primary" },
                { label: "Bewertungen", value: "9", icon: Star, trend: "+2%", color: "secondary" },
              ].map((kpi) => (
                <Card key={kpi.label} className="group border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden relative">
                  <div className={cn(
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mockUnternehmen.slice(0, 4).map((u) => (
                  <Card key={u.id} className="border-border/50 shadow-md hover:shadow-lg transition-all duration-300 group">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    {mockKunden.slice(0, 3).map((k) => (
                      <div key={k.id} className="flex items-center justify-between p-3 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors">
                        <div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {mockKunden.filter(k => !searchQuery || k.name.toLowerCase().includes(searchQuery.toLowerCase())).map((k) => (
                      <tr key={k.id} className="border-b border-border/30 hover:bg-muted/20 transition-colors">
                        ...
                        <td className="p-4">
                          <Button variant="outline" size="sm" className="rounded-xl text-xs h-8 font-medium hover:bg-primary/10 hover:text-primary hover:border-primary/30">öffnen</Button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex gap-2">
                {["Offen", "Bestätigt", "Storniert", "Alle"].map(f => (
                  <Button
                    key={f}
                    variant={buchungFilter === f ? "default" : "outline"}
                    size="sm"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredBuchungen.map((b) => (
                <Card key={b.id} className="border-border/50 shadow-md hover:shadow-lg transition-all duration-300 group overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {mockBewertungen.map((b) => (
                <Card key={b.id} className="border-border/50 shadow-md hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
              ...
              <div className="space-y-2">
                ...
                <Card className="border-border/50 overflow-hidden">
                  ...
                  <Textarea
                    ...
                    className="border-0 rounded-none min-h-[200px] focus-visible:ring-0 bg-transparent"
                  />
                </Card>
              </div>
