  ...
  const SectionHeader = ({ icon: Icon, title, number, color }: { icon: any; title: string; number: string; color: string }) => (
    <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "6px" }}>
      <div style={{
        ...
        background: `linear-gradient(135deg, ${color}, ${color}dd)`, boxShadow: `0 2px 6px ${color}30`, color: "white"
      }}>
        <Icon style={{ width: "10px", height: "10px" }} stroke="white" strokeWidth={2} color="white" />
      </div>
      <div style={{ display: "flex", alignItems: "baseline", gap: "4px" }}>
        <span style={{ fontSize: "6px", fontWeight: 700, color: color, opacity: 0.6 }}>{number}</span>
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] flex flex-col items-center py-8 px-4">
      ...
      <div
        ...
        style={{ width: "210mm", height: "297mm", maxHeight: "297mm", overflow: "hidden", padding: "0", fontFamily: "'Inter', -apple-system, sans-serif", position: "relative" }}
      >
        {/* Top gradient bar */}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div style={{ borderLeft: "2px solid #e2e8f0", paddingLeft: "10px" }}>
                <p style={{ fontSize: "14px", fontWeight: 800, color: "#1e293b", letterSpacing: "-0.02em", lineHeight: 1.2 }}>Anbieter-Profil</p>
