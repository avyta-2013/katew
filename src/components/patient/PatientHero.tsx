...
import { MapPin, Navigation, ArrowRight, Calendar, Clock, CheckCircle2, Shield, Heart, Zap } from "lucide-react";
import { useNavigate } from "react-router-dom";

const rotatingWords = ["sicher", "schnell", "einfach", "zuverlässig"];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/10 via-primary/5 to-secondary/10 border border-primary/20 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-foreground">
                Ihr vertrauenswürdiger Partner für Krankenfahrten
              </span>
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mt-4">
              Wir vermitteln qualifizierte Krankenfahrten – ob mit Verordnung oder als Selbstzahler. Einfach online buchen, bequem transportiert werden.
            </p>
          </motion.div>
          ...
          >
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-primary via-secondary to-primary rounded-3xl blur-lg opacity-30" />
              <div className="relative bg-card/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-border/50 p-6 md:p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="relative col-span-1">
                    ...
                    <Input type="date" className="h-12 pl-11 text-sm bg-muted/30 border-0 rounded-xl" />
                  </div>
                  <div className="relative col-span-1">
                    <Clock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                    <Input type="time" className="h-12 pl-11 text-sm bg-muted/30 border-0 rounded-xl" />
                  </div>
                  <motion.div className="col-span-2" whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                    <Button
                      size="lg"
